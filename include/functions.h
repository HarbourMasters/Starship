...
void ActorAllRange_SetShadowData(Actor* actor);
...
void ActorAllRange_Update(Actor* actor);
...
void Effect_Effect399_Setup(Effect* effect, f32 xPos, f32 yPos, f32 zPos, f32 xVel, f32 yVel, f32 zVel, f32 arg7, s32 arg8);
...
s32 FoBase_ExplodeCs(Boss* boss);
