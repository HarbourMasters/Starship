...
void Zoness_ZoBird_Draw(ZoBird* bird);
void Zoness_ZoBird_Update(ZoBird* bird);
void Zoness_ZoDodora_Update(Actor* actor);
void Zoness_ZoDodora_Draw(Actor* actor);
void Zoness_ZoFish_Update(Actor* actor);
void Zoness_ZoFish_Draw(Actor* actor);
void Zoness_ZoEnergyBall_Init(Actor* actor);
void Zoness_ZGull_Update(Actor* actor);
void Zoness_ZGull_Draw(Actor* actor);
void Zoness_ZoEnergyBall_Init2(Actor* actor);
void Zoness_ZoEnergyBall_Update(Actor* actor);
void Zoness_ZoEnergyBall_Draw(Actor* actor);
void Zoness_ZoTroika_Draw(Actor* actor);
void Zoness_ZoTroika_Update(Actor* actor);
void Zoness_ZoShrimp_Update(Actor* actor);
void Zoness_ZoShrimp_Draw(Actor* actor);
void Zoness_ZoObnema_Update(Actor* actor);
void Zoness_ZoObnema_Draw(Actor* actor);
void Zoness_ZoSarumarine_Init(Boss* boss);
void Zoness_ZoSarumarine_Draw(Boss* boss);
void Zoness_ZoSarumarine_Update(Boss* boss);
void Zoness_ZoBall_Update(ZoBall* ball);
void Zoness_ZoBall_Draw(Actor* actor);
void Zoness_ZoMine_Update(Actor* actor);
void Zoness_ZoMine_Draw(ZoMine* actor);
void Zoness_ZoCraneMagnet_Update(Actor* actor);
void Zoness_ZoCraneMagnet_Draw(Actor* actor);
void Zoness_ZoSpikeBall_Update(Actor* actor);
void Zoness_ZoSpikeBall_Draw(Actor* actor);
void Zoness_ZoTanker_Init(Actor* actor);
void Zoness_ZoTanker_Update(Actor* actor);
void Zoness_ZoTanker_Draw(Actor* actor);
void Zoness_ZoContainer_Init(Actor* actor);
void Zoness_ZoContainer_Update(Actor* actor);
void Zoness_ZoContainer_Draw(Actor* actor);
void Zoness_ZoRadarBuoy_Update(Actor* actor);
void Zoness_ZoRadarBuoy_Draw(Actor* actor);
void Zoness_ZoSupplyCrane_Init(Actor* actor);
void Zoness_ZoSupplyCrane_Update(Actor* actor);
void Zoness_ZoSupplyCrane_Draw(Actor* actor);
void Zoness_ZoSearchLight_Update(Actor* actor);
void Zoness_ZoSearchLight_Draw(Actor* actor);
void Zoness_ZoBarrier_Init(Actor* actor);
void Zoness_ZoBarrier_Update(Actor* actor);
void Zoness_ZoBarrier_Draw(Actor* actor);
