...
void Macbeth_801A7D98(Actor* actor) {
    ...
    actor->info.hitbox = LOAD_ASSET(gNoHitbox);
    D_i5_801BE320[14] = 0;
    D_i5_801BE320[15] = 0;
    gBossFrameCount = 0;
}
...
void Macbeth_LevelStart(Player* player) {
    ...
    switch (player->csState) {
        case 0:
            ...
            gLevelObjects = LOAD_ASSET(D_MA_6035678);
...
void Macbeth_801ACFBC(void) {
    ...
    gLevelObjects = LOAD_ASSET(D_MA_60357CC);
...
void Macbeth_801AD080(void) {
    ...
    gLevelObjects = LOAD_ASSET(D_MA_6035920);
...
void Macbeth_LevelComplete2(Player* player) {
    ...
    switch (gCsFrameCount) {
        ...
        case 1960:
            ...
            gActors[3].info.hitbox = LOAD_ASSET(gNoHitbox);
            break;
        case 2017:
