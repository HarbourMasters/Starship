...
void func_radio_800BAAE8(void) {
    ...
    if ((radioPortraitTex != NULL) && (gRadioPortraitScaleY != 0.0f)) {
        ...
        if (mirror) {
            TextureRect_16bRGBA_MirX(&gMasterDisp, radioPortraitTex, 44, 44, gRadioPortraitPosX,
                                     gRadioPortraitPosY + 20.0f + sp38 + gRadioPortraitScaleY, 1.0f, gRadioPortraitScaleY);
        } else {
            TextureRect_16bRGBA(&gMasterDisp, radioPortraitTex, 44, 44, gRadioPortraitPosX,
                                gRadioPortraitPosY + 20.0f + sp38 + gRadioPortraitScaleY, 1.0f, gRadioPortraitScaleY);
        }
    }
}
